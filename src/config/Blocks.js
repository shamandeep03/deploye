...
export default function Block() {
        ...
        <div class="container">
          <div class="row">
            <div class="col">
              ...
              ></div>
              <h2
                class="display-5 letter-spacing-xs text-center mb-0 font-black"
              >
          ...
          <div class="row">
            ...
            >
              ...
              <h5 class="font-semibold mt-2 mb-0">Hannah Hank</h5>
              <p class="font-semibold mt-0.5 mb-0 opacity-80 text-sm">CEO</p>
              <div class="inline-flex flex-row gap-x-3">
                <a href="#" title="linkedin">
                  <i class="fab fa-linkedin text-3xl text-dark"></i>
                </a>
                <a href="#" title="twitter">
                  <i class="fab fa-twitter text-3xl text-dark"></i>
                </a>
                <a href="#" title="facebook">
                  <i class="fab fa-facebook text-3xl text-dark"></i>
                </a>
              </div>
            </div>
            <div
            ...
            >
              ...
              <h5 class="font-semibold mt-2 mb-0">Joe Smith</h5>
              <p class="font-semibold mt-0.5 mb-0 opacity-80 text-sm">CMO</p>
              <div class="inline-flex flex-row gap-x-3">
                <a href="#" title="linkedin">
                  <i class="fab fa-linkedin text-3xl text-dark"></i>
                </a>
            ...
            >
              ...
              <h5 class="font-semibold mt-2 mb-0">Joseph Hims</h5>
              <p class="font-semibold mt-0.5 mb-0 opacity-80 text-sm">CFO</p>
              <div class="inline-flex flex-row gap-x-3">
                <a href="#" title="linkedin">
                  <i class="fab fa-linkedin text-3xl text-dark"></i>
                </a>
            ...
            >
              ...
              <h5 class="font-semibold mt-2 mb-0">Josina H. Hers</h5>
              <p class="font-semibold mt-0.5 mb-0 opacity-80 text-sm">COO</p>
              <div class="inline-flex flex-row gap-x-3">
                <a href="#" title="linkedin">
                  <i class="fab fa-linkedin text-3xl text-dark"></i>
                </a>
  ...
  ;}
    ...
    },
    {
      ...
      "
    >
      <div class="container" eid="e87147ba-d260-4099-9a42-13d2322b673f">
        <div class="row" eid="9ebf2f9b-fb13-45b9-b261-44d554eaa424">
          <div
            class="col md:w-8/12 mx-auto text-center mb-12"
            eid="7aee657d-47d1-475d-b7ca-51707823bcc1"
          >
            <h2
              class="display-4 font-semibold mb-3"
        ...
        <div class="row" eid="93ebe4a4-2070-493f-b9b2-40dd62ae7c2d">
          <div
            class="col md:w-4/12 mb-6"
            eid="c2697b19-3d6b-45a9-a8bc-2b3fb4735742"
          >
            <div class="text-center" eid="6e4acc5b-47d2-484f-ac6f-b11c99e514ff">
              <img
                src="https://templates.versoly.com/assets/img/headshot-man-1.jpg"
                class="max-w-full h-auto mx-auto mb-12"
              ...
              <div
                class="inline-flex flex-row gap-x-3"
              ...
              >
                <a
                  ...
                  ><i
                    class="fab fa-linkedin text-3xl"
                ...
                <a
                  ...
                  ><i
                    class="fab fa-facebook text-3xl"
          ...
          >
            <div class="text-center" eid="3acf67a5-df18-47cc-ad5c-bc71f88e9392">
              <img
          ...
          >
            <div class="text-center" eid="876b5732-1a3c-4cb1-a90b-53868b3cbc86">
              <img
        ...
        <div class="container">
          <div class="row">
            <div class="col md:w-8/12 mx-auto text-center mb-12">
              <h2 class="display-4 font-semibold mb-3">The Acme Inc Team</h2>
          ...
          <div class="row text-center md:text-left">
            ...
            >
              <img
                class="w-[150px] lg:w-[200px] mb-5 md:mb-0"
      ...
      >
        <div class="container">
          <div class="row text-center items-center justify-evenly">
            ...
            <div class="col">
              <h2 class="font-semibold mb-4">You'll be in great company</h2>
              <p class="w-9/12 mx-auto lg:mx-0">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Curabitur bibendum purus vel lobortis consequat.
              </p>
            </div>
            <div class="col w-4/12 md:w-2/12">
              <img
    ...
    >
      <div class="container">
        <div class="row">
          <div class="col">
            <h2 class="text-center pb-12">Trusted by Great Companies</h2>
          </div>
        </div>
        <div class="row filter grayscale lg:w-10/12 mx-auto">
          <div class="col md:w-2/12 w-4/12">
            <img
              alt="client logo 1"
    ...
    },
    {
      ...
      content: `  <section
      class="py-12 bg-primary-800"
      id="clients"
      eid="9a2e9a51-0520-4e96-b4cf-6c654c8e8ce4"
      style=""
    >
      <h2 class="text-center text-white font-semibold mb-3 h3">
        Featured on...
      </h2>
      <div class="container">
        <div class="mainrow  flex flex-col md:flex-row md:justify-center">
    ...
    >
      <div class="container" eid="052ce5c2-ebb1-4a5a-bad5-d40c0804b6d0">
        <div
          class="row items-center"
          eid="b2a1e97c-d7a0-4d72-9365-c6fe27918243"
        >
          <div class="col md:w-6/12" eid="c08cae56-1bd3-4574-88fb-30a7a8e8ecb4">
            <div
              class="
                relative
                flex flex-col
            ...
            >
              <h2
                class="display-6 text-center mb-6 font-semibold"
          ...
          <div
            class="col md:w-6/12 mt-8 md:mt-0 md:text-lg"
            eid="9c0154e9-3566-430a-a3cb-bf0a53c5e6d4"
          >
            <span
              class="bg-dark rounded text-white mb-3 px-3 py-2 block"
              role="alert"
    ...
    >
      <div class="container" eid="3243ba4a-2c4b-4b2b-bdb6-8843384dd56f">
        <div class="row" eid="ce90eefe-b987-45ad-bbf4-10f298746869">
          <div
            class="col md:w-10/12 lg:w-8/12 mx-auto text-center mb-6"
        ...
        <div class="row" eid="6a1a76f9-0e7e-4daf-8cd4-4a522b965cb9">
          <div
            class="col lg:w-3/12 my-12"
            eid="3945ca37-38ec-4be4-aa22-916d91fd2735"
          >
            <div
              class="border border-primary-300 rounded"
            ...
            >
              ...
              >
                <h3 class="m-0" eid="98c0d851-a5ac-415a-b9ed-cb3a083f8981">
                  Free
                </h3>
              </div>
              <div
                class="flex-auto p-6 text-center py-12 bg-primary-50"
                eid="f7e41691-00b8-4b76-8659-ee5789f8090f"
              >
                <h2
                  class="block h1 my-0 font-semibold"
                ...
                >
                  ...
                  >
                  <span
                    class="text-small text-lg m-0"
                    eid="c4b626f7-6f10-4df3-a4b0-124014fe99dc"
                    >/mo</span
                  >
                </h2>
              </div>
              <div class="p-5" eid="fe6f2708-d555-4dca-b150-eea26ba0f3c7">
                <ul
                  class="
                    fa-ul
                    flex flex-col
              ...
              <div
                class="flex-auto p-5 text-center bg-primary-50"
          ...
          >
            ...
            >
              <div
                class="p-6 text-center bg-primary text-white rounded-top"
                eid="04b03dc5-42c2-4fd8-b183-62a74f9da787"
              >
                <h3 class="m-0" eid="443d599d-845e-4c70-ac2a-9d467260cb9e">
                  Startup
                </h3>
              </div>
              <div
              ...
              <div class="p-5" eid="39c414dd-7808-46d5-8852-f9c2b1be9318">
                <ul
                  class="
                    fa-ul
                    flex flex-col
              ...
              <div
                class="flex-auto p-5 text-center bg-primary-50 rounded-bottom"
          ...
          >
            ...
            >
              ...
              >
                <h3 class="m-0" eid="e511a22c-623f-4707-99ec-19ad21c83f83">
                  Agency
                </h3>
              </div>
              <div
              ...
              <div class="p-5" eid="f0afac3d-ca89-4bcc-9e56-bad23da7dbe3">
                <ul
                  class="
                    fa-ul
                    flex flex-col
          ...
          >
            ...
            >
              ...
              >
                <h3 class="m-0" eid="6dcf889a-ac71-4fc8-8528-75097cd6b144">
                  Enterprise
                </h3>
              </div>
              <div
              ...
              <div class="p-5" eid="b6e3fd54-b191-486d-82a9-a0d4b0b72773">
                <ul
                  class="
                    fa-ul
                    flex flex-col
      ...
      <div class="container" eid="3243ba4a-2c4b-4b2b-bdb6-8843384dd56f">
        ...
        <div class="row">
          ...
          >
            ...
            <button
              class="btn btn-outline-primary rounded-none"
              id="annual-pricing-button"
              eid="9d3004b4-b129-46dd-9130-6a4991df9345"
            >
              Annual
        ...
        <div class="row" eid="6a1a76f9-0e7e-4daf-8cd4-4a522b965cb9">
          ...
          >
            ...
            >
              ...
              >
                <button
                  class="btn btn-lg block w-full btn-secondary"
                  eid="67a4b7c9-02c0-41f1-be9f-8c595b5f4e05"
                >
                  Try Now
                </button>
          ...
          >
            ...
            >
              ...
              >
                <a
                  class="btn btn-lg block w-full btn-primary"
                  href="javascript:void(0);"
                  eid="9a2617f4-158a-4c1a-bf9e-e8c9c1b79d5e"
                  >Try Now</a
                >
